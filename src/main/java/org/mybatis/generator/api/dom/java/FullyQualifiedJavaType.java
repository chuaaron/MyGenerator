...
public class FullyQualifiedJavaType implements Comparable<FullyQualifiedJavaType> {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof FullyQualifiedJavaType)) { return false; }
	...
	/**
	 * Gets the list instance.
	 *
	 * @return the list instance
	 */
	public static final FullyQualifiedJavaType getListInstance(FullyQualifiedJavaType tableName) {
		if (listInstance == null) {
			listInstance = new FullyQualifiedJavaType("List<" + tableName + ">"); //$NON-NLS-1$
		}
		return listInstance;
	}
	...
	private void parse(String fullTypeSpecification) {
		...
		if (spec.startsWith("?")) { //$NON-NLS-1$
			...
			if (index == -1) {
				...
				if (endIndex == -1) { throw new RuntimeException(getString(
	...
	private void genericParse(String genericSpecification) {
		...
		if (openCount != 0) { throw new RuntimeException(getString(
