...
public abstract class IntrospectedTable {
	...
	protected enum InternalAttribute {
		...
		/** the base page query conds id. */
		// TODO
		ATTR_BASE_QUERY_CONDS_ID,
		...
		if (columnName == null) {
			...
			for (IntrospectedColumn introspectedColumn : primaryKeyColumns) {
				if (introspectedColumn.isColumnNameDelimited()) {
					if (introspectedColumn.getActualColumnName().equals(columnName)) { return introspectedColumn; }
				} else {
					if (introspectedColumn.getActualColumnName().equalsIgnoreCase(columnName)) { return introspectedColumn; }
				}
			}
	...
	protected void calculateXmlAttributes() {
		...
		setBaseQueryCondsId("baseQueryConds"); //$NON-NLS-1$ TODO
	...
	public void setMyBatis3UpdateByExampleWhereClauseId(String s) {
		internalAttributes
				.put(InternalAttribute.ATTR_MYBATIS3_UPDATE_BY_EXAMPLE_WHERE_CLAUSE_ID, s);
	}
	...
	public void setUpdateByPrimaryKeySelectiveStatementId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_UPDATE_BY_PRIMARY_KEY_SELECTIVE_STATEMENT_ID,
				s);
	}
	...
	// TODO
	public String getBaseQueryCondsId() {
		return internalAttributes.get(InternalAttribute.ATTR_BASE_QUERY_CONDS_ID);
	}

	public void setBaseQueryCondsId(String s) {
		internalAttributes.put(InternalAttribute.ATTR_BASE_QUERY_CONDS_ID, s);
	}
	...
	protected void calculateJavaClientAttributes() {
		if (context.getJavaClientGeneratorConfiguration() == null) { return; }
